...
- [10 通过spring和JDBC征服数据库](#10-通过spring和jdbc征服数据库)
    - [10.1 spring的数据访问哲学](#101-spring的数据访问哲学)
        - [10.1.1 了解Spring的数据访问异常体系](#1011-了解spring的数据访问异常体系)
        - [10.1.2 数据访问模板化](#1012-数据访问模板化)
    - [10.2 配置数据源](#102-配置数据源)
        - [10.2.1 使用JNDI数据源](#1021-使用jndi数据源)
        - [10.2.2 使用数据源连接池](#1022-使用数据源连接池)
        - [10.2.3 基于JDBC驱动的数据源](#1023-基于jdbc驱动的数据源)
        - [10.2.4 使用嵌入式的数据源](#1024-使用嵌入式的数据源)
        - [10.2.5 使用profile切换数据源](#1025-使用profile切换数据源)
    - [10.3 在Spring中使用JDBC](#103-在spring中使用jdbc)
        - [10.3.1 面对失控的JDBC代码](#1031-面对失控的jdbc代码)
        - [10.3.2 使用JDBC模板](#1032-使用jdbc模板)
            - [使用JdbcTemplate来插入数据](#使用jdbctemplate来插入数据)
            - [在JdbcTemplate中使用java8的lambda表达式](#在jdbctemplate中使用java8的lambda表达式)
            - [使用命名参数](#使用命名参数)
